...
int main(int argc, char *argv[]) {
  ...
  14:	a1 20 0b 00 00       	mov    0xb20,%eax
  ...
  20:	74 58                	je     7a <main+0x7a>
    for (j = 0; j < number_of_processes; j++) {
  22:	a1 20 0b 00 00       	mov    0xb20,%eax
  ...
  3a:	83 c3 01             	add    $0x1,%ebx
            printf(1, "Fork failed\n");
  3d:	68 e8 07 00 00       	push   $0x7e8
  42:	6a 01                	push   $0x1
  44:	e8 77 04 00 00       	call   4c0 <printf>
    for (j = 0; j < number_of_processes; j++) {
  49:	a1 20 0b 00 00       	mov    0xb20,%eax
            continue;
  ...
  68:	39 1d 20 0b 00 00    	cmp    %ebx,0xb20
  ...
  84:	3b 05 20 0b 00 00    	cmp    0xb20,%eax
  ...
  ac:	3b 05 20 0b 00 00    	cmp    0xb20,%eax
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 67 fe ff ff       	call   373 <write>
 ...
 55e:	e8 10 fe ff ff       	call   373 <write>
        putc(fd, c);
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 4f fd ff ff       	call   373 <write>
        ap++;
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 13 08 00 00       	mov    $0x813,%edx
        while(*s != 0){
 ...
 661:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 24 0b 00 00    	mov    %edx,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
 ...
 753:	e8 83 fc ff ff       	call   3db <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 28 0b 00 00       	mov    $0xb28,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 28 0b 00 00 28 	movl   $0xb28,0xb28
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 2c 0b 00 00 00 	movl   $0x0,0xb2c
 7d2:	00 00 00 
    if(p->s.size >= nunits){
