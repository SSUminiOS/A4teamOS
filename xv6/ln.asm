 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 18 08 00 00 	jmp    *0x818(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 0f 08 00 00       	mov    $0x80f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 68 0b 00 00    	mov    %edx,0xb68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 68 0b 00 00    	mov    0xb68,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 6c 0b 00 00       	mov    $0xb6c,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 752:	00 00 00 
    if(p->s.size >= nunits){
