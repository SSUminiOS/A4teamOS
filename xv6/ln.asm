 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 08 08 00 00 	jmp    *0x808(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba ff 07 00 00       	mov    $0x7ff,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 58 0b 00 00    	mov    %edx,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 727:	0b 00 00 
    base.s.size = 0;
 72a:	bf 5c 0b 00 00       	mov    $0xb5c,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 736:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 742:	00 00 00 
    if(p->s.size >= nunits){
