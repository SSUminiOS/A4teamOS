...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 c0 1a 00 00       	push   $0x1ac0
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 c0 1a 00 00       	push   $0x1ac0
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 c0 1a 00 00 	movzbl 0x1ac0,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d c1 1a 00 00 64 	cmpb   $0x64,0x1ac1
      ...
      d8:	68 c0 1a 00 00       	push   $0x1ac0
      dd:	e8 7e 0b 00 00       	call   c60 <strlen>
      if(chdir(buf+3) < 0)
      e2:	c7 04 24 c3 1a 00 00 	movl   $0x1ac3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      e9:	c6 80 bf 1a 00 00 00 	movb   $0x0,0x1abf(%eax)
      if(chdir(buf+3) < 0)
     ...
     100:	51                   	push   %ecx
     101:	68 c3 1a 00 00       	push   $0x1ac3
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 b8 1a 00 00       	push   $0x1ab8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 b8 1a 00 00       	push   $0x1ab8
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 b0 1a 00 00       	push   $0x1ab0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 b8 1a 00 00       	push   $0x1ab8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 b8 1a 00 00       	push   $0x1ab8
...
/* for thread */
SYSCALL(clone)
     ed3:	b8 19 00 00 00       	mov    $0x19,%eax
     ed8:	cd 40                	int    $0x40
     eda:	c3                   	ret    

00000edb <join>:
SYSCALL(join)
     edb:	b8 1a 00 00 00       	mov    $0x1a,%eax
     ee0:	cd 40                	int    $0x40
     ee2:	c3                   	ret    

00000ee3 <gettid>:
SYSCALL(gettid) 
     ee3:	b8 1b 00 00 00       	mov    $0x1b,%eax
     ee8:	cd 40                	int    $0x40
     eea:	c3                   	ret    
     ...
     efc:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f29:	0f b6 92 90 14 00 00 	movzbl 0x1490(%edx),%edx
     ...
     fa9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1019:	ff 24 85 38 14 00 00 	jmp    *0x1438(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1127:	90                   	nop
          s = "(null)";
    1128:	ba 30 14 00 00       	mov    $0x1430,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1141:	a1 24 1b 00 00       	mov    0x1b24,%eax
{
  ...
  freep = p;
    ...
    1181:	5b                   	pop    %ebx
  freep = p;
    1182:	89 15 24 1b 00 00    	mov    %edx,0x1b24
}
    1188:	5e                   	pop    %esi
    1189:	5f                   	pop    %edi
    118a:	5d                   	pop    %ebp
  ...
  freep = p;
    11bc:	89 15 24 1b 00 00    	mov    %edx,0x1b24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11dc:	8b 3d 24 1b 00 00    	mov    0x1b24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1221:	8b 3d 24 1b 00 00    	mov    0x1b24,%edi
  ...
  return freep;
    124f:	8b 15 24 1b 00 00    	mov    0x1b24,%edx
    ...
    127c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    127f:	89 15 24 1b 00 00    	mov    %edx,0x1b24
}
    ...
    128f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1290:	c7 05 24 1b 00 00 28 	movl   $0x1b28,0x1b24
    1297:	1b 00 00 
    base.s.size = 0;
    129a:	bf 28 1b 00 00       	mov    $0x1b28,%edi
    base.s.ptr = freep = prevp = &base;
    129f:	c7 05 28 1b 00 00 28 	movl   $0x1b28,0x1b28
    12a6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12ab:	c7 05 2c 1b 00 00 00 	movl   $0x0,0x1b2c
    12b2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
    ...
    12db:	e8 f0 fe ff ff       	call   11d0 <malloc>

    if (stack == 0)
    12e0:	83 c4 10             	add    $0x10,%esp
    12e3:	85 c0                	test   %eax,%eax
    12e5:	74 25                	je     130c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
    12e7:	89 c2                	mov    %eax,%edx
    12e9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    12ef:	74 07                	je     12f8 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
    12f1:	29 d0                	sub    %edx,%eax
    12f3:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
    12f8:	83 ec 04             	sub    $0x4,%esp
    12fb:	50                   	push   %eax
    12fc:	ff 75 0c             	push   0xc(%ebp)
    12ff:	ff 75 08             	push   0x8(%ebp)
    1302:	e8 cc fb ff ff       	call   ed3 <clone>
    ...
    130c:	c9                   	leave  
        return -1;
    130d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    1312:	c3                   	ret    
    1313:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
int thread_join(int tid)
{
    ...
    1324:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
    1327:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
    132a:	50                   	push   %eax
    132b:	ff 75 08             	push   0x8(%ebp)
    132e:	e8 a8 fb ff ff       	call   edb <join>
    1333:	89 c3                	mov    %eax,%ebx
    free(stack);
    1335:	58                   	pop    %eax
    1336:	ff 75 f4             	push   -0xc(%ebp)
    1339:	e8 02 fe ff ff       	call   1140 <free>
    return retval;
}
    133e:	89 d8                	mov    %ebx,%eax
    1340:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1343:	c9                   	leave  
    1344:	c3                   	ret    
