     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 c8 1a 00 00       	push   $0x1ac8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 c8 1a 00 00       	push   $0x1ac8
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 c0 1a 00 00       	push   $0x1ac0
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 c8 1a 00 00       	push   $0x1ac8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 c8 1a 00 00       	push   $0x1ac8
...
00000eeb <threadinfo>:
SYSCALL(threadinfo) 
     eeb:	b8 1c 00 00 00       	mov    $0x1c,%eax
     ef0:	cd 40                	int    $0x40
     ef2:	c3                   	ret    
     ...
     f0c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f39:	0f b6 92 a0 14 00 00 	movzbl 0x14a0(%edx),%edx
     ...
     fb9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1029:	ff 24 85 48 14 00 00 	jmp    *0x1448(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1137:	90                   	nop
          s = "(null)";
    1138:	ba 40 14 00 00       	mov    $0x1440,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1151:	a1 44 1b 00 00       	mov    0x1b44,%eax
{
  ...
  freep = p;
    ...
    1191:	5b                   	pop    %ebx
  freep = p;
    1192:	89 15 44 1b 00 00    	mov    %edx,0x1b44
}
    1198:	5e                   	pop    %esi
    1199:	5f                   	pop    %edi
    119a:	5d                   	pop    %ebp
  ...
  freep = p;
    11cc:	89 15 44 1b 00 00    	mov    %edx,0x1b44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11ec:	8b 3d 44 1b 00 00    	mov    0x1b44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1231:	8b 3d 44 1b 00 00    	mov    0x1b44,%edi
  ...
  return freep;
    125f:	8b 15 44 1b 00 00    	mov    0x1b44,%edx
    ...
    128c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    128f:	89 15 44 1b 00 00    	mov    %edx,0x1b44
}
    ...
    129f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    12a0:	c7 05 44 1b 00 00 48 	movl   $0x1b48,0x1b44
    12a7:	1b 00 00 
    base.s.size = 0;
    12aa:	bf 48 1b 00 00       	mov    $0x1b48,%edi
    base.s.ptr = freep = prevp = &base;
    12af:	c7 05 48 1b 00 00 48 	movl   $0x1b48,0x1b48
    12b6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    12bb:	c7 05 4c 1b 00 00 00 	movl   $0x0,0x1b4c
    12c2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
    ...
    12eb:	e8 f0 fe ff ff       	call   11e0 <malloc>

    if (stack == 0)
    12f0:	83 c4 10             	add    $0x10,%esp
    12f3:	85 c0                	test   %eax,%eax
    12f5:	74 25                	je     131c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
    12f7:	89 c2                	mov    %eax,%edx
    12f9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    12ff:	74 07                	je     1308 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
    1301:	29 d0                	sub    %edx,%eax
    1303:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
    1308:	83 ec 04             	sub    $0x4,%esp
    130b:	50                   	push   %eax
    130c:	ff 75 0c             	push   0xc(%ebp)
    130f:	ff 75 08             	push   0x8(%ebp)
    1312:	e8 bc fb ff ff       	call   ed3 <clone>
    ...
    1322:	c3                   	ret    
    1323:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
int thread_join(int tid)
{
    ...
    1334:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
    1337:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
    133a:	50                   	push   %eax
    133b:	ff 75 08             	push   0x8(%ebp)
    133e:	e8 98 fb ff ff       	call   edb <join>
    1343:	89 c3                	mov    %eax,%ebx
    free(stack);
    1345:	58                   	pop    %eax
    1346:	ff 75 f4             	push   -0xc(%ebp)
    1349:	e8 02 fe ff ff       	call   1150 <free>
    return retval;
}
    134e:	89 d8                	mov    %ebx,%eax
    1350:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1353:	c9                   	leave  
    1354:	c3                   	ret    
