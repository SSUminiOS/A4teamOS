 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 08 08 00 00 	jmp    *0x808(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 01 08 00 00       	mov    $0x801,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 747:	0b 00 00 
    base.s.size = 0;
 74a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 756:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 762:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 795:	74 25                	je     7bc <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 797:	89 c2                	mov    %eax,%edx
 799:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 79f:	74 07                	je     7a8 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 7a1:	29 d0                	sub    %edx,%eax
 7a3:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 7b2:	e8 bc fb ff ff       	call   373 <clone>
 ...
 7bc:	c9                   	leave  
        return -1;
 7bd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7c2:	c3                   	ret    
...
{
 7d7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 7da:	50                   	push   %eax
 7db:	ff 75 08             	push   0x8(%ebp)
 7de:	e8 98 fb ff ff       	call   37b <join>
 7e3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7e5:	58                   	pop    %eax
 7e6:	ff 75 f4             	push   -0xc(%ebp)
 7e9:	e8 02 fe ff ff       	call   5f0 <free>
    return retval;
}
