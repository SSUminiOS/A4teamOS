...
_threadinfo:     file format elf32-i386
...
int main(void)
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
	threadinfo();
   6:	e8 20 03 00 00       	call   32b <threadinfo>
	exit();
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 469:	ff 24 85 a0 07 00 00 	jmp    *0x7a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 577:	90                   	nop
          s = "(null)";
 578:	ba 98 07 00 00       	mov    $0x798,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 591:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 4f                	jae    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 6cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 ...
 6df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 6f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 702:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 72b:	e8 f0 fe ff ff       	call   620 <malloc>

    if (stack == 0)
 730:	83 c4 10             	add    $0x10,%esp
 733:	85 c0                	test   %eax,%eax
 735:	74 25                	je     75c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 737:	89 c2                	mov    %eax,%edx
 739:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 73f:	74 07                	je     748 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 741:	29 d0                	sub    %edx,%eax
 743:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 748:	83 ec 04             	sub    $0x4,%esp
 74b:	50                   	push   %eax
 74c:	ff 75 0c             	push   0xc(%ebp)
 74f:	ff 75 08             	push   0x8(%ebp)
 752:	e8 bc fb ff ff       	call   313 <clone>
 ...
 75c:	c9                   	leave  
        return -1;
 75d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 762:	c3                   	ret    
...
int thread_join(int tid)
{
 ...
 774:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 777:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 77a:	50                   	push   %eax
 77b:	ff 75 08             	push   0x8(%ebp)
 77e:	e8 98 fb ff ff       	call   31b <join>
 783:	89 c3                	mov    %eax,%ebx
    free(stack);
 785:	58                   	pop    %eax
 786:	ff 75 f4             	push   -0xc(%ebp)
 789:	e8 02 fe ff ff       	call   590 <free>
    return retval;
}
 78e:	89 d8                	mov    %ebx,%eax
 790:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 793:	c9                   	leave  
 794:	c3                   	ret    
