 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 d8 08 00 00 	jmp    *0x8d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba d0 08 00 00       	mov    $0x8d0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 7e7:	0e 00 00 
    base.s.size = 0;
 7ea:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 7f6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 802:	00 00 00 
    if(p->s.size >= nunits){
