 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba c0 08 00 00       	mov    $0x8c0,%edx
        while(*s != 0){
 ...
 681:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 7d7:	0e 00 00 
    base.s.size = 0;
 7da:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 7e6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 7f2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 816:	68 00 10 00 00       	push   $0x1000
 81b:	e8 f0 fe ff ff       	call   710 <malloc>

    if (stack == 0)
 820:	83 c4 10             	add    $0x10,%esp
 823:	85 c0                	test   %eax,%eax
 825:	74 25                	je     84c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 827:	89 c2                	mov    %eax,%edx
 829:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 82f:	74 07                	je     838 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 831:	29 d0                	sub    %edx,%eax
 833:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 842:	e8 cc fb ff ff       	call   413 <clone>
...
int thread_join(int tid)
{
 ...
 864:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 867:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 86a:	50                   	push   %eax
 86b:	ff 75 08             	push   0x8(%ebp)
 86e:	e8 a8 fb ff ff       	call   41b <join>
 873:	89 c3                	mov    %eax,%ebx
    free(stack);
 875:	58                   	pop    %eax
 876:	ff 75 f4             	push   -0xc(%ebp)
 879:	e8 02 fe ff ff       	call   680 <free>
    return retval;
}
