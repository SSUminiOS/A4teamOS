 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba fc 07 00 00       	mov    $0x7fc,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 752:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 77b:	e8 f0 fe ff ff       	call   670 <malloc>

    if (stack == 0)
 780:	83 c4 10             	add    $0x10,%esp
 783:	85 c0                	test   %eax,%eax
 785:	74 25                	je     7ac <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 787:	89 c2                	mov    %eax,%edx
 789:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 78f:	74 07                	je     798 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 791:	29 d0                	sub    %edx,%eax
 793:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 7a2:	e8 bc fb ff ff       	call   363 <clone>
 ...
 7ac:	c9                   	leave  
        return -1;
 7ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7b2:	c3                   	ret    
 7b3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 7ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000007c0 <thread_join>:
...
int thread_join(int tid)
{
 ...
 7c4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 7c7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 7ca:	50                   	push   %eax
 7cb:	ff 75 08             	push   0x8(%ebp)
 7ce:	e8 98 fb ff ff       	call   36b <join>
 7d3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7d5:	58                   	pop    %eax
 7d6:	ff 75 f4             	push   -0xc(%ebp)
 7d9:	e8 02 fe ff ff       	call   5e0 <free>
    return retval;
}
 7de:	89 d8                	mov    %ebx,%eax
