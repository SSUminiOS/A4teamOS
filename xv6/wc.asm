 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 90 09 00 00 	movzbl 0x990(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 38 09 00 00 	jmp    *0x938(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba 2f 09 00 00       	mov    $0x92f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 e0 0e 00 00       	mov    0xee0,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 e0 0e 00 00    	mov    %edx,0xee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 ...
 83f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 e0 0e 00 00 e4 	movl   $0xee4,0xee0
 847:	0e 00 00 
    base.s.size = 0;
 84a:	bf e4 0e 00 00       	mov    $0xee4,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 e4 0e 00 00 e4 	movl   $0xee4,0xee4
 856:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 85b:	c7 05 e8 0e 00 00 00 	movl   $0x0,0xee8
 862:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 886:	68 00 10 00 00       	push   $0x1000
 88b:	e8 f0 fe ff ff       	call   780 <malloc>

    if (stack == 0)
 890:	83 c4 10             	add    $0x10,%esp
 893:	85 c0                	test   %eax,%eax
 895:	74 25                	je     8bc <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 897:	89 c2                	mov    %eax,%edx
 899:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 89f:	74 07                	je     8a8 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 8a1:	29 d0                	sub    %edx,%eax
 8a3:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 8a8:	83 ec 04             	sub    $0x4,%esp
 8ab:	50                   	push   %eax
 8ac:	ff 75 0c             	push   0xc(%ebp)
 8af:	ff 75 08             	push   0x8(%ebp)
 8b2:	e8 cc fb ff ff       	call   483 <clone>
 ...
 8bc:	c9                   	leave  
        return -1;
 8bd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 8c2:	c3                   	ret    
...
{
 8d7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 8da:	50                   	push   %eax
 8db:	ff 75 08             	push   0x8(%ebp)
 8de:	e8 a8 fb ff ff       	call   48b <join>
 8e3:	89 c3                	mov    %eax,%ebx
    free(stack);
 8e5:	58                   	pop    %eax
 8e6:	ff 75 f4             	push   -0xc(%ebp)
 8e9:	e8 02 fe ff ff       	call   6f0 <free>
    return retval;
}
 8ee:	89 d8                	mov    %ebx,%eax
