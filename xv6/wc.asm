 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 48 09 00 00 	jmp    *0x948(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 3f 09 00 00       	mov    $0x93f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 e0 0e 00 00       	mov    0xee0,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 e0 0e 00 00    	mov    %edx,0xee0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d e0 0e 00 00    	mov    0xee0,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 e0 0e 00 00    	mov    0xee0,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 e0 0e 00 00    	mov    %edx,0xee0
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 e0 0e 00 00 e4 	movl   $0xee4,0xee0
 857:	0e 00 00 
    base.s.size = 0;
 85a:	bf e4 0e 00 00       	mov    $0xee4,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 e4 0e 00 00 e4 	movl   $0xee4,0xee4
 866:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 e8 0e 00 00 00 	movl   $0x0,0xee8
 872:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 896:	68 00 10 00 00       	push   $0x1000
 89b:	e8 f0 fe ff ff       	call   790 <malloc>

    if (stack == 0)
 8a0:	83 c4 10             	add    $0x10,%esp
 8a3:	85 c0                	test   %eax,%eax
 8a5:	74 25                	je     8cc <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 8a7:	89 c2                	mov    %eax,%edx
 8a9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 8af:	74 07                	je     8b8 <thread_create+0x28>
 ...
 8bb:	50                   	push   %eax
 8bc:	ff 75 0c             	push   0xc(%ebp)
 8bf:	ff 75 08             	push   0x8(%ebp)
 8c2:	e8 bc fb ff ff       	call   483 <clone>
...
{
 8e7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 8ea:	50                   	push   %eax
 8eb:	ff 75 08             	push   0x8(%ebp)
 8ee:	e8 98 fb ff ff       	call   48b <join>
 8f3:	89 c3                	mov    %eax,%ebx
    free(stack);
 8f5:	58                   	pop    %eax
 8f6:	ff 75 f4             	push   -0xc(%ebp)
 8f9:	e8 02 fe ff ff       	call   700 <free>
    return retval;
}
 8fe:	89 d8                	mov    %ebx,%eax
 900:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 903:	c9                   	leave  
 904:	c3                   	ret    
