 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 18 09 00 00 	movzbl 0x918(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 c0 08 00 00 	jmp    *0x8c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba b8 08 00 00       	mov    $0x8b8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 18 0c 00 00       	mov    0xc18,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 18 0c 00 00    	mov    %edx,0xc18
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 18 0c 00 00    	mov    %edx,0xc18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 18 0c 00 00    	mov    0xc18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 18 0c 00 00    	mov    0xc18,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 18 0c 00 00    	mov    0xc18,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 18 0c 00 00    	mov    %edx,0xc18
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 18 0c 00 00 1c 	movl   $0xc1c,0xc18
 7b7:	0c 00 00 
    base.s.size = 0;
 7ba:	bf 1c 0c 00 00       	mov    $0xc1c,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 1c 0c 00 00 1c 	movl   $0xc1c,0xc1c
 7c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 20 0c 00 00 00 	movl   $0x0,0xc20
 7d2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 7f6:	68 00 10 00 00       	push   $0x1000
 7fb:	e8 f0 fe ff ff       	call   6f0 <malloc>

    if (stack == 0)
 800:	83 c4 10             	add    $0x10,%esp
 803:	85 c0                	test   %eax,%eax
 805:	74 25                	je     82c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 807:	89 c2                	mov    %eax,%edx
 809:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 80f:	74 07                	je     818 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 811:	29 d0                	sub    %edx,%eax
 813:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 818:	83 ec 04             	sub    $0x4,%esp
 81b:	50                   	push   %eax
 81c:	ff 75 0c             	push   0xc(%ebp)
 81f:	ff 75 08             	push   0x8(%ebp)
 822:	e8 cc fb ff ff       	call   3f3 <clone>
 ...
 82c:	c9                   	leave  
        return -1;
 82d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 832:	c3                   	ret    
 833:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 83a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000840 <thread_join>:
 ...
 844:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 84e:	e8 a8 fb ff ff       	call   3fb <join>
 853:	89 c3                	mov    %eax,%ebx
    free(stack);
 855:	58                   	pop    %eax
 856:	ff 75 f4             	push   -0xc(%ebp)
 859:	e8 02 fe ff ff       	call   660 <free>
    return retval;
}
 85e:	89 d8                	mov    %ebx,%eax
