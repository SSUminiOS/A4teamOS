 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 28 09 00 00 	movzbl 0x928(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 d0 08 00 00 	jmp    *0x8d0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba c8 08 00 00       	mov    $0x8c8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 28 0c 00 00    	mov    %edx,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 7c7:	0c 00 00 
    base.s.size = 0;
 7ca:	bf 2c 0c 00 00       	mov    $0xc2c,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 2c 0c 00 00 2c 	movl   $0xc2c,0xc2c
 7d6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 7e2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 832:	e8 bc fb ff ff       	call   3f3 <clone>
 ...
 854:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 85e:	e8 98 fb ff ff       	call   3fb <join>
