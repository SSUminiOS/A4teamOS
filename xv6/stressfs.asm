 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 599:	ff 24 85 f4 08 00 00 	jmp    *0x8f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba eb 08 00 00       	mov    $0x8eb,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 50 0c 00 00       	mov    0xc50,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 50 0c 00 00    	mov    %edx,0xc50
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 50 0c 00 00    	mov    %edx,0xc50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 50 0c 00 00    	mov    0xc50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 50 0c 00 00    	mov    0xc50,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 50 0c 00 00    	mov    0xc50,%edx
 ...
 817:	0c 00 00 
    base.s.size = 0;
 81a:	bf 54 0c 00 00       	mov    $0xc54,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 58 0c 00 00 00 	movl   $0x0,0xc58
 832:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 856:	68 00 10 00 00       	push   $0x1000
 85b:	e8 f0 fe ff ff       	call   750 <malloc>

    if (stack == 0)
 860:	83 c4 10             	add    $0x10,%esp
 863:	85 c0                	test   %eax,%eax
 865:	74 25                	je     88c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 867:	89 c2                	mov    %eax,%edx
 869:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 86f:	74 07                	je     878 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 871:	29 d0                	sub    %edx,%eax
 873:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 878:	83 ec 04             	sub    $0x4,%esp
 87b:	50                   	push   %eax
 87c:	ff 75 0c             	push   0xc(%ebp)
 87f:	ff 75 08             	push   0x8(%ebp)
 882:	e8 bc fb ff ff       	call   443 <clone>
 ...
 88c:	c9                   	leave  
        return -1;
 88d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 892:	c3                   	ret    
 893:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 89a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000008a0 <thread_join>:
...
int thread_join(int tid)
{
 ...
 8a4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 8a7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 8aa:	50                   	push   %eax
 8ab:	ff 75 08             	push   0x8(%ebp)
 8ae:	e8 98 fb ff ff       	call   44b <join>
 8b3:	89 c3                	mov    %eax,%ebx
    free(stack);
 8b5:	58                   	pop    %eax
 8b6:	ff 75 f4             	push   -0xc(%ebp)
 8b9:	e8 02 fe ff ff       	call   6c0 <free>
    return retval;
}
 8be:	89 d8                	mov    %ebx,%eax
 8c0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8c3:	c9                   	leave  
 8c4:	c3                   	ret    
