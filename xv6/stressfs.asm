 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 e4 08 00 00 	jmp    *0x8e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba db 08 00 00       	mov    $0x8db,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 40 0c 00 00       	mov    0xc40,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 40 0c 00 00    	mov    %edx,0xc40
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 40 0c 00 00    	mov    %edx,0xc40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 40 0c 00 00    	mov    0xc40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 40 0c 00 00    	mov    0xc40,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 40 0c 00 00    	mov    0xc40,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 40 0c 00 00    	mov    %edx,0xc40
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 40 0c 00 00 44 	movl   $0xc44,0xc40
 807:	0c 00 00 
    base.s.size = 0;
 80a:	bf 44 0c 00 00       	mov    $0xc44,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 44 0c 00 00 44 	movl   $0xc44,0xc44
 816:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 48 0c 00 00 00 	movl   $0x0,0xc48
 822:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 846:	68 00 10 00 00       	push   $0x1000
 84b:	e8 f0 fe ff ff       	call   740 <malloc>

    if (stack == 0)
 850:	83 c4 10             	add    $0x10,%esp
 853:	85 c0                	test   %eax,%eax
 855:	74 25                	je     87c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 857:	89 c2                	mov    %eax,%edx
 859:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 85f:	74 07                	je     868 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 861:	29 d0                	sub    %edx,%eax
 863:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 868:	83 ec 04             	sub    $0x4,%esp
 86b:	50                   	push   %eax
 86c:	ff 75 0c             	push   0xc(%ebp)
 86f:	ff 75 08             	push   0x8(%ebp)
 872:	e8 cc fb ff ff       	call   443 <clone>
...
int thread_join(int tid)
{
 ...
 894:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 897:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 89a:	50                   	push   %eax
 89b:	ff 75 08             	push   0x8(%ebp)
 89e:	e8 a8 fb ff ff       	call   44b <join>
 8a3:	89 c3                	mov    %eax,%ebx
    free(stack);
 8a5:	58                   	pop    %eax
 8a6:	ff 75 f4             	push   -0xc(%ebp)
 8a9:	e8 02 fe ff ff       	call   6b0 <free>
    return retval;
}
