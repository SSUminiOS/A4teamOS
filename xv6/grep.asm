...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 80 0f 00 00    	lea    0xf80(%ecx),%eax
 204:	50                   	push   %eax
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 80 0f 00 00 	movl   $0xf80,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 80 0f 00 00 00 	movb   $0x0,0xf80(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2bb:	81 fa 80 0f 00 00    	cmp    $0xf80,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d 80 0f 00 00       	sub    $0xf80,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 80 0f 00 00       	push   $0xf80
      m -= p - buf;
...
0000067b <join>:
SYSCALL(join)
 67b:	b8 1a 00 00 00       	mov    $0x1a,%eax
 680:	cd 40                	int    $0x40
 682:	c3                   	ret    
 ...
 6ac:	89 d1                	mov    %edx,%ecx
{
 ...
 6d9:	0f b6 92 90 0b 00 00 	movzbl 0xb90(%edx),%edx
 ...
 759:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7c9:	ff 24 85 38 0b 00 00 	jmp    *0xb38(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8d7:	90                   	nop
          s = "(null)";
 8d8:	ba 2e 0b 00 00       	mov    $0xb2e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f1:	a1 80 13 00 00       	mov    0x1380,%eax
{
 ...
 931:	5b                   	pop    %ebx
  freep = p;
 932:	89 15 80 13 00 00    	mov    %edx,0x1380
}
 938:	5e                   	pop    %esi
 939:	5f                   	pop    %edi
 93a:	5d                   	pop    %ebp
 ...
 969:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 96c:	89 15 80 13 00 00    	mov    %edx,0x1380
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 3d 80 13 00 00    	mov    0x1380,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9cf:	73 4f                	jae    a20 <malloc+0xa0>
    ...
    if(p == freep)
 9d1:	8b 3d 80 13 00 00    	mov    0x1380,%edi
 ...
 9fa:	e8 f1 fe ff ff       	call   8f0 <free>
  return freep;
 9ff:	8b 15 80 13 00 00    	mov    0x1380,%edx
 ...
 a2c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a2f:	89 15 80 13 00 00    	mov    %edx,0x1380
}
 ...
 a3f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a40:	c7 05 80 13 00 00 84 	movl   $0x1384,0x1380
 a47:	13 00 00 
    base.s.size = 0;
 a4a:	bf 84 13 00 00       	mov    $0x1384,%edi
    base.s.ptr = freep = prevp = &base;
 a4f:	c7 05 84 13 00 00 84 	movl   $0x1384,0x1384
 a56:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a59:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a5b:	c7 05 88 13 00 00 00 	movl   $0x0,0x1388
 a62:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 a86:	68 00 10 00 00       	push   $0x1000
 a8b:	e8 f0 fe ff ff       	call   980 <malloc>

    if (stack == 0)
 a90:	83 c4 10             	add    $0x10,%esp
 a93:	85 c0                	test   %eax,%eax
 a95:	74 25                	je     abc <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 a97:	89 c2                	mov    %eax,%edx
 a99:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 a9f:	74 07                	je     aa8 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 aa1:	29 d0                	sub    %edx,%eax
 aa3:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 aa8:	83 ec 04             	sub    $0x4,%esp
 aab:	50                   	push   %eax
 aac:	ff 75 0c             	push   0xc(%ebp)
 aaf:	ff 75 08             	push   0x8(%ebp)
 ab2:	e8 bc fb ff ff       	call   673 <clone>
...
int thread_join(int tid)
{
 ...
 ad4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ad7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 ada:	50                   	push   %eax
 adb:	ff 75 08             	push   0x8(%ebp)
 ade:	e8 98 fb ff ff       	call   67b <join>
 ae3:	89 c3                	mov    %eax,%ebx
    free(stack);
 ae5:	58                   	pop    %eax
 ae6:	ff 75 f4             	push   -0xc(%ebp)
 ae9:	e8 02 fe ff ff       	call   8f0 <free>
    return retval;
}
