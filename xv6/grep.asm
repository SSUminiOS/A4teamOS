 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 6c9:	0f b6 92 80 0b 00 00 	movzbl 0xb80(%edx),%edx
 ...
 749:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b9:	ff 24 85 28 0b 00 00 	jmp    *0xb28(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8c7:	90                   	nop
          s = "(null)";
 8c8:	ba 1e 0b 00 00       	mov    $0xb1e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 80 13 00 00       	mov    0x1380,%eax
{
 ...
 921:	5b                   	pop    %ebx
  freep = p;
 922:	89 15 80 13 00 00    	mov    %edx,0x1380
}
 928:	5e                   	pop    %esi
 929:	5f                   	pop    %edi
 92a:	5d                   	pop    %ebp
 ...
 959:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 95c:	89 15 80 13 00 00    	mov    %edx,0x1380
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 3d 80 13 00 00    	mov    0x1380,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 4f                	jae    a10 <malloc+0xa0>
    ...
    if(p == freep)
 9c1:	8b 3d 80 13 00 00    	mov    0x1380,%edi
 ...
 9ea:	e8 f1 fe ff ff       	call   8e0 <free>
  return freep;
 9ef:	8b 15 80 13 00 00    	mov    0x1380,%edx
 ...
 a1c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a1f:	89 15 80 13 00 00    	mov    %edx,0x1380
}
 ...
 a2f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 80 13 00 00 84 	movl   $0x1384,0x1380
 a37:	13 00 00 
    base.s.size = 0;
 a3a:	bf 84 13 00 00       	mov    $0x1384,%edi
    base.s.ptr = freep = prevp = &base;
 a3f:	c7 05 84 13 00 00 84 	movl   $0x1384,0x1384
 a46:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a49:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a4b:	c7 05 88 13 00 00 00 	movl   $0x0,0x1388
 a52:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 a76:	68 00 10 00 00       	push   $0x1000
 a7b:	e8 f0 fe ff ff       	call   970 <malloc>

    if (stack == 0)
 a80:	83 c4 10             	add    $0x10,%esp
 a83:	85 c0                	test   %eax,%eax
 a85:	74 25                	je     aac <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 a87:	89 c2                	mov    %eax,%edx
 a89:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 a8f:	74 07                	je     a98 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 a91:	29 d0                	sub    %edx,%eax
 a93:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 a98:	83 ec 04             	sub    $0x4,%esp
 a9b:	50                   	push   %eax
 a9c:	ff 75 0c             	push   0xc(%ebp)
 a9f:	ff 75 08             	push   0x8(%ebp)
 aa2:	e8 cc fb ff ff       	call   673 <clone>
...
{
 ac7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 aca:	50                   	push   %eax
 acb:	ff 75 08             	push   0x8(%ebp)
 ace:	e8 a8 fb ff ff       	call   67b <join>
 ad3:	89 c3                	mov    %eax,%ebx
    free(stack);
 ad5:	58                   	pop    %eax
 ad6:	ff 75 f4             	push   -0xc(%ebp)
 ad9:	e8 02 fe ff ff       	call   8e0 <free>
    return retval;
}
 ade:	89 d8                	mov    %ebx,%eax
