...
int main(int argc, char** argv) {
  ...
  14:	74 2b                	je     41 <main+0x41>
    ...
    {
        if(argc>1)
  16:	7e 16                	jle    2e <main+0x2e>
        printf(1,"ERROR : ps : too many arguments\n");
  18:	52                   	push   %edx
  19:	52                   	push   %edx
  1a:	68 c8 07 00 00       	push   $0x7c8
  1f:	6a 01                	push   $0x1
  21:	e8 fa 03 00 00       	call   420 <printf>
  26:	83 c4 10             	add    $0x10,%esp
            exit();
  29:	e8 75 02 00 00       	call   2a3 <exit>
        else
        printf(1,"ERROR : ps : too less arguments\n");
  2e:	50                   	push   %eax
  2f:	50                   	push   %eax
  30:	68 ec 07 00 00       	push   $0x7ec
  35:	6a 01                	push   $0x1
  37:	e8 e4 03 00 00       	call   420 <printf>
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	eb e8                	jmp    29 <main+0x29>
        if(getps()<0)
  41:	e8 05 03 00 00       	call   34b <getps>
  46:	eb e1                	jmp    29 <main+0x29>
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 6c 08 00 00 	movzbl 0x86c(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 14 08 00 00 	jmp    *0x814(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 0d 08 00 00       	mov    $0x80d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 717:	0b 00 00 
    base.s.size = 0;
 71a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 726:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 732:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 756:	68 00 10 00 00       	push   $0x1000
 75b:	e8 f0 fe ff ff       	call   650 <malloc>

    if (stack == 0)
 760:	83 c4 10             	add    $0x10,%esp
 763:	85 c0                	test   %eax,%eax
 765:	74 25                	je     78c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 767:	89 c2                	mov    %eax,%edx
 769:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 76f:	74 07                	je     778 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 771:	29 d0                	sub    %edx,%eax
 773:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 782:	e8 cc fb ff ff       	call   353 <clone>
...
{
 7a7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 7aa:	50                   	push   %eax
 7ab:	ff 75 08             	push   0x8(%ebp)
 7ae:	e8 a8 fb ff ff       	call   35b <join>
 7b3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7b5:	58                   	pop    %eax
 7b6:	ff 75 f4             	push   -0xc(%ebp)
 7b9:	e8 02 fe ff ff       	call   5c0 <free>
    return retval;
}
 7be:	89 d8                	mov    %ebx,%eax
 7c0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 7c3:	c9                   	leave  
 7c4:	c3                   	ret    
