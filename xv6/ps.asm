 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 1d 08 00 00       	mov    $0x81d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 70 0b 00 00    	mov    %edx,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 727:	0b 00 00 
    base.s.size = 0;
 72a:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 736:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 742:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 766:	68 00 10 00 00       	push   $0x1000
 76b:	e8 f0 fe ff ff       	call   660 <malloc>

    if (stack == 0)
 770:	83 c4 10             	add    $0x10,%esp
 773:	85 c0                	test   %eax,%eax
 775:	74 25                	je     79c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 777:	89 c2                	mov    %eax,%edx
 779:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 77f:	74 07                	je     788 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 781:	29 d0                	sub    %edx,%eax
 783:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 792:	e8 bc fb ff ff       	call   353 <clone>
 ...
 79c:	c9                   	leave  
        return -1;
 79d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7a2:	c3                   	ret    
...
int thread_join(int tid)
{
 ...
 7b4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 7b7:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 7ba:	50                   	push   %eax
 7bb:	ff 75 08             	push   0x8(%ebp)
 7be:	e8 98 fb ff ff       	call   35b <join>
 7c3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7c5:	58                   	pop    %eax
 7c6:	ff 75 f4             	push   -0xc(%ebp)
 7c9:	e8 02 fe ff ff       	call   5d0 <free>
    return retval;
}
 7ce:	89 d8                	mov    %ebx,%eax
