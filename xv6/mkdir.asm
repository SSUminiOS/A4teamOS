 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 3b 08 00 00       	mov    $0x83b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 a0 0b 00 00    	mov    %edx,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 766:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 772:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 796:	68 00 10 00 00       	push   $0x1000
 79b:	e8 f0 fe ff ff       	call   690 <malloc>

    if (stack == 0)
 7a0:	83 c4 10             	add    $0x10,%esp
 7a3:	85 c0                	test   %eax,%eax
 7a5:	74 25                	je     7cc <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 7a7:	89 c2                	mov    %eax,%edx
 7a9:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 7af:	74 07                	je     7b8 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 7b1:	29 d0                	sub    %edx,%eax
 7b3:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 7c2:	e8 bc fb ff ff       	call   383 <clone>
 ...
 7cc:	c9                   	leave  
        return -1;
 7cd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 7d2:	c3                   	ret    
 ...
 7e4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 7ee:	e8 98 fb ff ff       	call   38b <join>
 7f3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7f5:	58                   	pop    %eax
 7f6:	ff 75 f4             	push   -0xc(%ebp)
 7f9:	e8 02 fe ff ff       	call   600 <free>
    return retval;
}
