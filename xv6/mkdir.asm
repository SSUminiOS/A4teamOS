 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 34 08 00 00 	jmp    *0x834(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 2b 08 00 00       	mov    $0x82b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 90 0b 00 00    	mov    %edx,0xb90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 90 0b 00 00    	mov    0xb90,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 747:	0b 00 00 
    base.s.size = 0;
 74a:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 756:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 762:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 7b2:	e8 cc fb ff ff       	call   383 <clone>
 ...
 7d4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 7de:	e8 a8 fb ff ff       	call   38b <join>
