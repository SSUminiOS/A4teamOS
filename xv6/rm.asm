 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 3c 08 00 00 	jmp    *0x83c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 35 08 00 00       	mov    $0x835,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 98 0b 00 00    	mov    %edx,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 766:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 772:	00 00 00 
    if(p->s.size >= nunits){
