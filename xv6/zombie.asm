 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 c0 07 00 00 	jmp    *0x7c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba b8 07 00 00       	mov    $0x7b8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 707:	0b 00 00 
    base.s.size = 0;
 70a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 716:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 722:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 746:	68 00 10 00 00       	push   $0x1000
 74b:	e8 f0 fe ff ff       	call   640 <malloc>

    if (stack == 0)
 750:	83 c4 10             	add    $0x10,%esp
 753:	85 c0                	test   %eax,%eax
 755:	74 25                	je     77c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 757:	89 c2                	mov    %eax,%edx
 759:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 75f:	74 07                	je     768 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 761:	29 d0                	sub    %edx,%eax
 763:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 768:	83 ec 04             	sub    $0x4,%esp
 76b:	50                   	push   %eax
 76c:	ff 75 0c             	push   0xc(%ebp)
 76f:	ff 75 08             	push   0x8(%ebp)
 772:	e8 bc fb ff ff       	call   333 <clone>
...
{
 797:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 79a:	50                   	push   %eax
 79b:	ff 75 08             	push   0x8(%ebp)
 79e:	e8 98 fb ff ff       	call   33b <join>
 7a3:	89 c3                	mov    %eax,%ebx
    free(stack);
 7a5:	58                   	pop    %eax
 7a6:	ff 75 f4             	push   -0xc(%ebp)
 7a9:	e8 02 fe ff ff       	call   5b0 <free>
    return retval;
}
 7ae:	89 d8                	mov    %ebx,%eax
