 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 08 08 00 00 	movzbl 0x808(%edx),%edx
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba a8 07 00 00       	mov    $0x7a8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 fc 0a 00 00    	mov    %edx,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 6f7:	0b 00 00 
    base.s.size = 0;
 6fa:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 706:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 712:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 736:	68 00 10 00 00       	push   $0x1000
 73b:	e8 f0 fe ff ff       	call   630 <malloc>

    if (stack == 0)
 740:	83 c4 10             	add    $0x10,%esp
 743:	85 c0                	test   %eax,%eax
 745:	74 25                	je     76c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 747:	89 c2                	mov    %eax,%edx
 749:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 74f:	74 07                	je     758 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 751:	29 d0                	sub    %edx,%eax
 753:	05 00 10 00 00       	add    $0x1000,%eax
    
    return clone(function, arg, stack);
 758:	83 ec 04             	sub    $0x4,%esp
 75b:	50                   	push   %eax
 75c:	ff 75 0c             	push   0xc(%ebp)
 75f:	ff 75 08             	push   0x8(%ebp)
 762:	e8 cc fb ff ff       	call   333 <clone>
 ...
 76c:	c9                   	leave  
        return -1;
 76d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 772:	c3                   	ret    
 773:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
{
 787:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 78a:	50                   	push   %eax
 78b:	ff 75 08             	push   0x8(%ebp)
 78e:	e8 a8 fb ff ff       	call   33b <join>
 793:	89 c3                	mov    %eax,%ebx
    free(stack);
 795:	58                   	pop    %eax
 796:	ff 75 f4             	push   -0xc(%ebp)
 799:	e8 02 fe ff ff       	call   5a0 <free>
    return retval;
}
