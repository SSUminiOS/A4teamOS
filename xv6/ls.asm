...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb e0 0e 00 00       	mov    $0xee0,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 e0 0e 00 00       	add    $0xee0,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 719:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 897:	90                   	nop
          s = "(null)";
 898:	ba 02 0b 00 00       	mov    $0xb02,%edx
        while(*s != 0){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 a4b:	e8 f0 fe ff ff       	call   940 <malloc>

    if (stack == 0)
 a50:	83 c4 10             	add    $0x10,%esp
 a53:	85 c0                	test   %eax,%eax
 a55:	74 25                	je     a7c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 a57:	89 c2                	mov    %eax,%edx
 a59:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 a5f:	74 07                	je     a68 <thread_create+0x28>
 ...
 a72:	e8 cc fb ff ff       	call   643 <clone>
 ...
 a7c:	c9                   	leave  
        return -1;
 a7d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 a82:	c3                   	ret    
...
int thread_join(int tid)
{
 ...
 a94:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 a97:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 a9a:	50                   	push   %eax
 a9b:	ff 75 08             	push   0x8(%ebp)
 a9e:	e8 a8 fb ff ff       	call   64b <join>
 aa3:	89 c3                	mov    %eax,%ebx
    free(stack);
 aa5:	58                   	pop    %eax
 aa6:	ff 75 f4             	push   -0xc(%ebp)
 aa9:	e8 02 fe ff ff       	call   8b0 <free>
    return retval;
}
