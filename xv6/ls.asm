...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb f0 0e 00 00       	mov    $0xef0,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 f0 0e 00 00       	add    $0xef0,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6a9:	0f b6 92 74 0b 00 00 	movzbl 0xb74(%edx),%edx
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 799:	ff 24 85 1c 0b 00 00 	jmp    *0xb1c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8a7:	90                   	nop
          s = "(null)";
 8a8:	ba 12 0b 00 00       	mov    $0xb12,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c1:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 901:	5b                   	pop    %ebx
  freep = p;
 902:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 908:	5e                   	pop    %esi
 909:	5f                   	pop    %edi
 90a:	5d                   	pop    %ebp
 ...
 939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 93c:	89 15 00 0f 00 00    	mov    %edx,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 4f                	jae    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9a1:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
 ...
 9ca:	e8 f1 fe ff ff       	call   8c0 <free>
  return freep;
 9cf:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 9fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 ...
 a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 a17:	0f 00 00 
    base.s.size = 0;
 a1a:	bf 04 0f 00 00       	mov    $0xf04,%edi
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 a26:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a2b:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 a32:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 a82:	e8 bc fb ff ff       	call   643 <clone>
 ...
 aa4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 aae:	e8 98 fb ff ff       	call   64b <join>
