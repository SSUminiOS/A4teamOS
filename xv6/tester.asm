...
int main(int argc, char *argv[]) {
  ...
  14:	a1 fc 0b 00 00       	mov    0xbfc,%eax
  ...
  3a:	83 c3 01             	add    $0x1,%ebx
            printf(1, "Fork failed\n");
  3d:	68 78 08 00 00       	push   $0x878
  42:	6a 01                	push   $0x1
  44:	e8 87 04 00 00       	call   4d0 <printf>
    for (j = 0; j < number_of_processes; j++) {
  49:	a1 fc 0b 00 00       	mov    0xbfc,%eax
            continue;
  ...
  98:	e8 46 03 00 00       	call   3e3 <sleep>
  ...
  ac:	3b 05 fc 0b 00 00    	cmp    0xbfc,%eax
  ...
  e5:	e8 e9 02 00 00       	call   3d3 <getpid>
  ea:	53                   	push   %ebx
  eb:	50                   	push   %eax
  ec:	68 85 08 00 00       	push   $0x885
  f1:	6a 01                	push   $0x1
  f3:	e8 d8 03 00 00       	call   4d0 <printf>
            exit();
  f8:	e8 56 02 00 00       	call   353 <exit>
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 04 09 00 00 	movzbl 0x904(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 ac 08 00 00 	jmp    *0x8ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba a3 08 00 00       	mov    $0x8a3,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 00 0c 00 00       	mov    0xc00,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 00 0c 00 00    	mov    %edx,0xc00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 00 0c 00 00    	mov    0xc00,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 00 0c 00 00    	mov    0xc00,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 00 0c 00 00    	mov    %edx,0xc00
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 00 0c 00 00 04 	movl   $0xc04,0xc00
 7c7:	0c 00 00 
    base.s.size = 0;
 7ca:	bf 04 0c 00 00       	mov    $0xc04,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 04 0c 00 00 04 	movl   $0xc04,0xc04
 7d6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 7e2:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 803:	83 ec 14             	sub    $0x14,%esp
    void *stack = malloc(PGSIZE);
 806:	68 00 10 00 00       	push   $0x1000
 80b:	e8 f0 fe ff ff       	call   700 <malloc>

    if (stack == 0)
 810:	83 c4 10             	add    $0x10,%esp
 813:	85 c0                	test   %eax,%eax
 815:	74 25                	je     83c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 817:	89 c2                	mov    %eax,%edx
 819:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 81f:	74 07                	je     828 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 821:	29 d0                	sub    %edx,%eax
 823:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 832:	e8 cc fb ff ff       	call   403 <clone>
...
{
 857:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 85a:	50                   	push   %eax
 85b:	ff 75 08             	push   0x8(%ebp)
 85e:	e8 a8 fb ff ff       	call   40b <join>
 863:	89 c3                	mov    %eax,%ebx
    free(stack);
 865:	58                   	pop    %eax
 866:	ff 75 f4             	push   -0xc(%ebp)
 869:	e8 02 fe ff ff       	call   670 <free>
    return retval;
}
 86e:	89 d8                	mov    %ebx,%eax
 870:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 873:	c9                   	leave  
 874:	c3                   	ret    
