...
int main(int argc, char *argv[]) {
  ...
  14:	a1 1c 0c 00 00       	mov    0xc1c,%eax
  19:	85 c0                	test   %eax,%eax
  1b:	7f 11                	jg     2e <main+0x2e>
  1d:	eb 51                	jmp    70 <main+0x70>
  1f:	90                   	nop
        int pid = fork();
        if (pid < 0) {
        ...
        if (pid == 0) {
  20:	74 58                	je     7a <main+0x7a>
    for (j = 0; j < number_of_processes; j++) {
  22:	a1 1c 0c 00 00       	mov    0xc1c,%eax
  27:	83 c3 01             	add    $0x1,%ebx
  2a:	39 d8                	cmp    %ebx,%eax
  2c:	7e 27                	jle    55 <main+0x55>
        int pid = fork();
  2e:	e8 28 03 00 00       	call   35b <fork>
        if (pid < 0) {
  33:	85 c0                	test   %eax,%eax
  35:	79 e9                	jns    20 <main+0x20>
            printf(1, "Fork failed\n");
  37:	83 ec 08             	sub    $0x8,%esp
    for (j = 0; j < number_of_processes; j++) {
  3a:	83 c3 01             	add    $0x1,%ebx
            printf(1, "Fork failed\n");
  3d:	68 98 08 00 00       	push   $0x898
  42:	6a 01                	push   $0x1
  44:	e8 a7 04 00 00       	call   4f0 <printf>
    for (j = 0; j < number_of_processes; j++) {
  49:	a1 1c 0c 00 00       	mov    0xc1c,%eax
            continue;
  4e:	83 c4 10             	add    $0x10,%esp
    for (j = 0; j < number_of_processes; j++) {
  51:	39 d8                	cmp    %ebx,%eax
  53:	7f d9                	jg     2e <main+0x2e>
            //yield();
            getps();
            exit();
        } 
  ...
  57:	7e 17                	jle    70 <main+0x70>
  59:	31 db                	xor    %ebx,%ebx
  5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  5f:	90                   	nop
        wait();
  60:	e8 06 03 00 00       	call   36b <wait>
    for (j = 0; j < number_of_processes; j++) {
  65:	83 c3 01             	add    $0x1,%ebx
  68:	39 1d 1c 0c 00 00    	cmp    %ebx,0xc1c
  6e:	7f f0                	jg     60 <main+0x60>
    }
    getps();
  70:	e8 96 03 00 00       	call   40b <getps>
    exit();
  75:	e8 e9 02 00 00       	call   363 <exit>
            for (volatile int k = 0; k < number_of_processes; k++) {  //io time
  7a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  81:	8b 45 f4             	mov    -0xc(%ebp),%eax
  84:	3b 05 1c 0c 00 00    	cmp    0xc1c,%eax
  8a:	7c 28                	jl     b4 <main+0xb4>
  8c:	eb 57                	jmp    e5 <main+0xe5>
  8e:	66 90                	xchg   %ax,%ax
                    sleep(200);
  90:	83 ec 0c             	sub    $0xc,%esp
  93:	68 c8 00 00 00       	push   $0xc8
  98:	e8 56 03 00 00       	call   3f3 <sleep>
  ...
  ac:	3b 05 1c 0c 00 00    	cmp    0xc1c,%eax
  ...
  c5:	3d ff c1 eb 0b       	cmp    $0xbebc1ff,%eax
  ...
  dc:	3d ff c1 eb 0b       	cmp    $0xbebc1ff,%eax
  e1:	7e ed                	jle    d0 <main+0xd0>
  e3:	eb bb                	jmp    a0 <main+0xa0>
            printf(1, "Process: PID %d :%d Finished\n", getpid(), j);
  e5:	e8 f9 02 00 00       	call   3e3 <getpid>
  ea:	53                   	push   %ebx
  eb:	50                   	push   %eax
  ec:	68 a5 08 00 00       	push   $0x8a5
  f1:	6a 01                	push   $0x1
  f3:	e8 f8 03 00 00       	call   4f0 <printf>
            getps();
  f8:	e8 0e 03 00 00       	call   40b <getps>
            exit();
  fd:	e8 61 02 00 00       	call   363 <exit>
...
00000423 <gettid>:
SYSCALL(gettid)
 423:	b8 1b 00 00 00       	mov    $0x1b,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret    
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 cc 08 00 00 	jmp    *0x8cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba c3 08 00 00       	mov    $0x8c3,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 20 0c 00 00       	mov    0xc20,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 20 0c 00 00    	mov    %edx,0xc20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 20 0c 00 00    	mov    0xc20,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 20 0c 00 00 24 	movl   $0xc24,0xc20
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 24 0c 00 00       	mov    $0xc24,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 28 0c 00 00 00 	movl   $0x0,0xc28
 802:	00 00 00 
    if(p->s.size >= nunits){
...
int thread_create(void (*function) (void *), void *arg)
{
 ...
 823:	83 ec 14             	sub    $0x14,%esp
    void *stack = malloc(PGSIZE);
 826:	68 00 10 00 00       	push   $0x1000
 82b:	e8 f0 fe ff ff       	call   720 <malloc>

    if (stack == 0)
 830:	83 c4 10             	add    $0x10,%esp
 833:	85 c0                	test   %eax,%eax
 835:	74 25                	je     85c <thread_create+0x3c>
        return -1;
    if ((uint)stack % PGSIZE != 0)
 837:	89 c2                	mov    %eax,%edx
 839:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 83f:	74 07                	je     848 <thread_create+0x28>
        stack += PGSIZE - ((uint)stack % PGSIZE);
 841:	29 d0                	sub    %edx,%eax
 843:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 852:	e8 bc fb ff ff       	call   413 <clone>
...
{
 877:	83 ec 1c             	sub    $0x1c,%esp
    retval = join(tid, &stack);
 87a:	50                   	push   %eax
 87b:	ff 75 08             	push   0x8(%ebp)
 87e:	e8 98 fb ff ff       	call   41b <join>
 883:	89 c3                	mov    %eax,%ebx
    free(stack);
 885:	58                   	pop    %eax
 886:	ff 75 f4             	push   -0xc(%ebp)
 889:	e8 02 fe ff ff       	call   690 <free>
    return retval;
}
